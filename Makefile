...
SRC = builtin/ft_built_in.c          execute/ft_wait.c               heredoc/ft_expend_heredoc.c  libft/ft_putstr_fd.c  libft/ft_strnjoin.c          list/ft_memset.c         utils/ft_env_utils.c \
	  ...
	  builtin/ft_echo.c              builtin/ft_env.c                builtin/ft_exit.c            libft/ft_atoi.c       builtin/ft_unset.c           builtin/ft_cd.c list/ft_lstsize.c
