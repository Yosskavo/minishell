...
SRC =  ft_parce.c     ft_puterror.c    ft_word.c           libft/ft_isalpha.c  libft/ft_putstr_fd.c  libft/ft_strstr.c     list/ft_list_add_back.c  minishell.c \
			 ...
			 libft/ft_strdup.c   libft/ft_itoa.c ft_heredoc_fork.c ft_signal.c  ft_status.c       libft/ft_lengh_of_table.c       ft_heredoc.c    libft/ft_strcmp.c libft/ft_strjoin.c   libft/ft_freetable.c
